...
- Supabase PostgreSQL (existing `bookings` table, read-only) (030-create-feature-branch)
- [e.g., Python 3.11, Swift 5.9, Rust 1.75 or NEEDS CLARIFICATION] + [e.g., FastAPI, UIKit, LLVM or NEEDS CLARIFICATION] (030-create-feature-branch)
